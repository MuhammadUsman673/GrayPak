  ...
  return (
    <nav className="navbar">
      ...
      <div className={`navbar-links ${menuOpen ? 'active' : ''}`}>
        ...
        <Link to="/outlet" className="main-link">Outlet</Link>
      </div>

      {/* Icons and Login */}
      <div className="navbar-icons">
        <Link to="/search" className="icon"><FaSearch /></Link>
        <Link to="/favourites" className="icon favourites-icon"><FaHeart /></Link>
        <Link to="/login" className="icon">Login</Link>
        <Link to="/cart" className="cart-button">Bag: 0</Link>
      </div>
    </nav>
  );
};
